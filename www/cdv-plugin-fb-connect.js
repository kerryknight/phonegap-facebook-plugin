...
module.exports = {
    ...
    login: function (params, cb, fail) {
        ...
        exec(function (e) { // login
            ...
            if (cb) cb(e);
        }, (fail ? fail : null), 'FB', 'login', params.scope.split(','));
    },
    logout: function (cb, fail) {
        exec(function (e) {
            ...
            if (cb) cb(e);
        }, (fail ? fail : null), 'FB', 'logout', []);
    },
    getLoginStatus: function (cb, fail) {
        exec(function (e) {
            if (cb) cb(e);
        }, (fail ? fail : null), 'FB', 'getLoginStatus', []);
    },
    dialog: function (params, cb, fail) {
        exec(function (e) { // login
            if (cb) cb(e);
        }, (fail ? fail : null), 'FB', 'showDialog', [params]);
    }
};